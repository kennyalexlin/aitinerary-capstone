...
# This file contains all the shared data models for the application.
# It has no other local imports, so it can be safely imported by any other module.

class FlightInfo(BaseModel):
    # This is the modern Pydantic V2 way to configure the model.
    model_config = ConfigDict(
        # This tells FastAPI/Pydantic how to convert 'date' objects to a JSON string.
        json_encoders={date: lambda v: v.isoformat()},
        # This prevents errors if the LLM hallucinates extra fields.
        extra="ignore"
    )
    ...
    # --- CHANGE 1: Set logical defaults for passenger counts ---
    ...
    # --- CHANGE 2: Enforce strict categories for routing ---
        ...
        if isinstance(v, str):
            try:
                ...
                try:
                    ...
                    # Return as string if parsing fails - will be handled elsewhere
                    return v
        return v

class UserInfo(BaseModel):
    # Apply the same modern V2 configuration here.
    model_config = ConfigDict(
        json_encoders={date: lambda v: v.isoformat()},
        extra="ignore"
    )
...
# --- The rest of the models do not need changes as they don't contain special types ---
