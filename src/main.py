...
print("Available custom actions:", list(custom_controller.registry.registry.actions.keys()))
...
async def main():
    ...
    print(f"Total booking runtime: {minutes} min {seconds} sec")
    logging.info(f"Total booking runtime: {minutes} min {seconds} sec")
